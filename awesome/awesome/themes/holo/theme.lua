...
local weather = lain.widget.weather({
    city_id = 3459712, -- placeholder (Joinville SC)
...
local weawidget = wibox.container.background(weather.widget, theme.bg_focus, gears.shape.rectangle)
...
local currency_widget = wibox.widget {
    temp_widget,
...
currency_widget:connect_signal("mouse::enter", function()
    naughty.notify{
        text = "A USD values " .. resp.rates.BRL .." BRL\nLast updated in: " .. resp.date ,
